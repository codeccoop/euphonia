...
export class UserDetailView {
  ...
  private fillUserInfo() {
    ...
    this.userinfo
      .eadd("<div class=euid />")
      .etext(`User ${this.user.euid}${deletedText}`);
    ...
    buttons
      .eadd("<button />")
      .etext("Assign tasks")
      .on("click", async (e) => await this.startAssign());
    buttons
      .eadd("<button />")
      .etext("Unassign all remaining tasks")
      .on("click", async (e) => await this.unassignAll());
    buttons
      .eadd("<button />")
      .etext("Delete user")
      .on("click", async (e) => await this.deleteUser());
