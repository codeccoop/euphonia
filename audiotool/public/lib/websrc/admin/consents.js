 ...
 */
define(["require", "exports", "../dialog", "../../commonsrc/util", "../util", "./consentdetail"], function (require, exports, dialog_1, util_1, util_2, consentdetail_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ConsentsView = void 0;
    ...
    <th class=date>Created</th><th>Users</th></tr></thead>`);
            ...
            for (const [, consent] of this.app.data.consents) {
                ...
                tr.eadd('<td class=date />').text((0, util_1.formatTimestamp)(consent.creationTimestamp));
        ...
        async startConsentDetail(cid) {
            ...
            if (!consent) {
                (0, util_2.toast)(`Unknown Consent: ${cid}`);
                return;
            }
            this.consentdetail = new consentdetail_1.ConsentDetailView(this, consent);
            await this.consentdetail.start();
        }
    }
    exports.ConsentsView = ConsentsView;
    // Creates a consent
    class AddConsentDialog extends dialog_1.Dialog {
        constructor(parent) {
            super('consentdialog');
            this.parent = parent;
            ...
            addButton.on('click', async (e) => {
                ...
                const tags = (0, util_1.parseTags)(tagsField.val());
                ...
                if (parent.app.data.consents.get(id)) {
                    (0, util_2.toast)(`Consent with ID already exists: ${id}`);
                    return;
                }
