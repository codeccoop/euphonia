 ...
 */
define(["require", "exports", "../commonsrc/localization", "../commonsrc/schema"], function (require, exports, localization_1, schema_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Swiper = exports.Dropdown = exports.Spinner = exports.isIOS = exports.errorToast = exports.toast = exports.postAsJson = exports.isSafari = exports.authenticatedFetch = exports.toURL = exports.animateCss = exports.fadeOut = exports.fadeIn = exports.animateOpacity = exports.fork = exports.sleepFrame = exports.sleep = exports.setDisplayLanguage = void 0;
    ...
    $.fn.eitext = function (formatString, ...args) {
        return this.etext((0, localization_1.formatWithArgs)(CURRENT_LANGUAGE, formatString, ...args));
    };
    $.fn.eihtml = function (formatString, ...args) {
        return this.ehtml((0, localization_1.formatWithArgs)(CURRENT_LANGUAGE, formatString, ...args));
    };
    $.fn.eiprop = function (propertyName, formatString, ...args) {
        this.prop(propertyName, (0, localization_1.formatWithArgs)(CURRENT_LANGUAGE, formatString, ...args));
        return this;
    };
