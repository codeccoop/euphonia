...
define(["require", "exports", "./util"], function (require, exports, util_1) {
    ...
    class SignupView {
        ...
        to do so.`);
            ...
            questionBox1.eadd('<label for=strangerscheckbox class=row1 />').eitext(`Strangers, or voice technologies like Google Assistant, have difficulty understanding my speech (not because of an accent)`);
            ...
            this.authExplain = questionBox1.eadd('<div class=accountexplain />').eitext(`You will need to sign in with your Google
