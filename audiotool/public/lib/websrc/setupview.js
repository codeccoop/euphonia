...
define(["require", "exports", "./util"], function (require, exports, util_1) {
    ...
    class SetupView {
        constructor(app) {
            this.passive = false; // Set to true if the calling GUI wants us to immediately continue.
            this.fastCheck = false; // Set to true if we got an instant / non-interactive response from getUserMedia()
            this.showSettings = false; // Set to true if the user clicks the settings button
            this.app = app;
            this.data = app.data;
    ...
    class MicrophoneSettingsPanel {
        constructor(view) {
            this.defaultCheckbox = undefined;
            this.devicesList = undefined;
            this.deviceCheckboxIds = new Map();
            this.saveButton = undefined;
            this.cancelButton = undefined;
            // What we know about the microphone devices
            this.canConfigure = false; // true if there are any real choices to make
            this.hasDefault = false; // true if there was an explicit "default" device choice
            this.devices = [];
