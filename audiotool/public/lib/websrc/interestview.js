 ...
 */
define(["require", "exports", "../commonsrc/util"], function (require, exports, util_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InterestView = void 0;
    ...
    class InterestView {
        ...
        checkRequired(selector, message, check) {
            const elem = $(selector);
        ...
        fill(d) {
            const setText = (id, t) => $(id).val(t ? t : '');
            const setBool = (id, val) => $(id).echecked(val);
            // Clear error states
            ...
            if (d.gender && !(0, util_1.listhas)(d.gender, 'female', 'male', 'undisclosed')) {
            ...
            setBool('#ifdevicecomputer', (0, util_1.listhas)('computer', ...deviceList));
            setBool('#ifdeviceandroid', (0, util_1.listhas)('androidphone', ...deviceList));
            setBool('#ifdeviceiphone', (0, util_1.listhas)('iphone', ...deviceList));
            setBool('#ifdevicenone', (0, util_1.listhas)('none', ...deviceList));
            setBool('#ifdeviceother', false);
            setText('#ifdeviceothertext', '');
            for (const device of deviceList) {
                if (!(0, util_1.listhas)(device, 'computer', 'androidphone', 'iphone', 'none', '')) {
    ...
    exports.InterestView = InterestView;
});
//# sourceMappingURL=interestview.js.map