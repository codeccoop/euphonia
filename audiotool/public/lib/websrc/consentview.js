...
define(["require", "exports", "./util"], function (require, exports, util_1) {
    ...
    class ConsentView {
        ...
        async displayConsentIdx(idx) {
            ...
            if (idx !== 0 || !isLast) {
                $('#consentcounter').eihtml(`&nbsp;(Agreement {which_agreement_number} of {total_number_of_agreements})`, 'which_agreement_number', `${idx + 1}`, 'total_number_of_agreements', `${consentCount}`);
            }
    ...
    exports.ConsentView = ConsentView;
});
