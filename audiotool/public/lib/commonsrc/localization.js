 ...
 */
define(["require", "exports", "./strings_en", "./strings_es", "./strings_fr", "./strings_hi", "./strings_ja"], function (require, exports, strings_en_1, strings_es_1, strings_fr_1, strings_hi_1, strings_ja_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.formatWithArgs = exports.LOCALIZED_STRINGS = void 0;
    // Describes all localizations
    exports.LOCALIZED_STRINGS = new Map([
        ['en-US', toLocaleTable(strings_en_1.EN_STRINGS)],
        ['en-GB', toLocaleTable(strings_en_1.EN_STRINGS)],
        ['es-ES', toLocaleTable(strings_es_1.ES_STRINGS)],
        ['fr-FR', toLocaleTable(strings_fr_1.FR_STRINGS)],
        ['hi-HI', toLocaleTable(strings_hi_1.HI_STRINGS)],
        ['ja-JP', toLocaleTable(strings_ja_1.JA_STRINGS)],
    ]);
    ...
    function formatWithArgs(lang, formatString, ...argsList) {
        ...
        const langMap = exports.LOCALIZED_STRINGS.get(lang);
    ...
    exports.formatWithArgs = formatWithArgs;
});
